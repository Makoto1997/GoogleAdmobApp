...
class TableViewController: UITableViewController,GADBannerViewDelegate,GADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        backImageView.frame = CGRect(x: 0, y: 0, width: view.frame.size.width, height: view.frame.size.width)
        backImageView.image = image
        tableView.backgroundView = backImageView
        
        interstitial = creatAndLoadInterstitial()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0{
            ...
            bannerView.adUnitID = "ca-app-pub-6920435367310913/2202083436"
    ...
    func creatAndLoadInterstitial() -> GADInterstitial{
        ...
        var interstitial = GADInterstitial(adUnitID: "ca-app-pub-6920435367310913/5137747271")
